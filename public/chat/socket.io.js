...
(function (global, factory) {
  ...
  function pick(obj) {
    for (
      var _len = arguments.length, attr = new Array(_len > 1 ? _len - 1 : 0), _key = 1;
      _key < _len;
      _key++
    ) {
  ...
  function parse(str) {
    ...
    if (b != -1 && e != -1) {
      str =
        str.substring(0, b) + str.substring(b, e).replace(/:/g, ';') + str.substring(e, str.length);
    }
      ...
      },
      {
        ...
        value: function getWritablePackets() {
          var shouldCheckPayloadSize =
            this.maxPayload && this.transport.name === 'polling' && this.writeBuffer.length > 1;
    ...
    _createClass(Encoder, [
      {
        ...
        value: function encode(obj) {
          if (obj.type === PacketType.EVENT || obj.type === PacketType.ACK) {
            if (hasBinary(obj)) {
              obj.type =
                obj.type === PacketType.EVENT ? PacketType.BINARY_EVENT : PacketType.BINARY_ACK;
            ...
            if (typeof obj === 'string') {
              ...
              if (
                ...
                if (packet.attachments === 0) {
                  _get(_getPrototypeOf(Decoder.prototype), 'emitReserved', this).call(
                    this,
                    'decoded',
                    packet
                  );
  ...
  function lookup(uri, opts) {
    ...
    var newConnection =
      opts.forceNew || opts['force new connection'] || false === opts.multiplex || sameNamespace;
    var io;
