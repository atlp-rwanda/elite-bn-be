...
use(chaiHttp);
const user={firstName:'Kalisa',lastName:'Kevin',email:'kevinkalisa@gmail.com',password:'andela@123',
}
const invalidEmail={firstName:'Kalisa',lastName:'Kevin',email:'kevnkalisaemailcon',password:'andela@123'}
const invalidPassword={firstName:'Kalisa',lastName:'Kevin',email:'kevinkalisa@gmail.com',password:'andela123'}
